...
#define __cpp_lib_transparent_operators 201510
  ...
  /** @defgroup logical_functors bool Operations Classes
   * @ingroup functors
   *
   *  Here are wrapper functors for bool operations: @c &&, @c ||,
   *  and @c !.
   *
   *  @{
   */
  ...
  /// One of the @link logical_functors bool operations functors@endlink.
  template<typename _Tp>
